...
The default mapping is read from `~/.fscrawler/_default/2/doc.json` which you can read from [the source](src/main/resources/fr/pilato/elasticsearch/crawler/fs/2/doc.json). 
