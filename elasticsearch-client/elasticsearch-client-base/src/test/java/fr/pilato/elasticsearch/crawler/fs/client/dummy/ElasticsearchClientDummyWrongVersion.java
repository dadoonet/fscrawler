...
public class ElasticsearchClientDummyWrongVersion extends ElasticsearchClientDummyBase {

    public ElasticsearchClientDummyWrongVersion(Path path, FsSettings settings) {
