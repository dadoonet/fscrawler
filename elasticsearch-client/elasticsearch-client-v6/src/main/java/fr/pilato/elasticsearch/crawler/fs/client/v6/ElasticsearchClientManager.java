...
import fr.pilato.elasticsearch.crawler.fs.client.v5.ElasticsearchClientBase;
...
public class ElasticsearchClientManager {
    ...
    private ElasticsearchClientBase client = null;
    ...
    public void start() throws Exception {
        ...
        try {
            ...
            client = new ElasticsearchClientBase(ElasticsearchClientBase.buildRestClient(settings.getElasticsearch()));
