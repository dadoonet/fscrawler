...
import static fr.pilato.elasticsearch.crawler.fs.client.v5.ElasticsearchClientV5.buildRestClient;
...
public class ElasticsearchClientManager {
    private final Logger logger = LogManager.getLogger(fr.pilato.elasticsearch.crawler.fs.client.ElasticsearchClientManager.class);
    ...
    public ElasticsearchClientBase client() {
        if (client == null) {
