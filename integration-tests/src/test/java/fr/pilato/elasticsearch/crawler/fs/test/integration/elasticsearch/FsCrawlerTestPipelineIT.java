 ...
 */
public class FsCrawlerTestPipelineIT extends AbstractFsCrawlerITCase {

    @Test
    public void test_noop_pipeline() throws Exception {
        var pipeline = new Pipeline();
        pipeline.setClassName("fr.pilato.elasticsearch.crawler.fs.test.integration.elasticsearch.NoopProcessingPipeline");
