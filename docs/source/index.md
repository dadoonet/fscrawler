...
```{note}
FS Crawler {{ release }} is using {{ Tika_version }} and is tested against:

* {{ ES_version9 }}.
* {{ ES_version8 }}.
* {{ ES_version7 }}. (Deprecated)
```
...
To support JPEG 2000 (JPX/JP2) images, you need to manually add {{ JPEG2000_version }} library to
...
See
[pdfbox documentation](https://pdfbox.apache.org/2.0/dependencies.html#jai-image-io)
