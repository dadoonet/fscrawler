...
+=======================================+=================================================+==================+===================================+
| ``fs.ocr.enabled``                    | ``FSCRAWLER_FS_OCR_ENABLED``                    | ``true``         | `Disable/Enable OCR`_             |
+---------------------------------------+-------------------------------------------------+------------------+-----------------------------------+
| ``fs.ocr.language``                   | ``FSCRAWLER_FS_OCR_LANGUAGE``                   | ``"eng"``        | `OCR Language`_                   |
+---------------------------------------+-------------------------------------------------+------------------+-----------------------------------+
| ``fs.ocr.path``                       | ``FSCRAWLER_FS_OCR_PATH``                       | ``null``         | `OCR Path`_                       |
+---------------------------------------+-------------------------------------------------+------------------+-----------------------------------+
| ``fs.ocr.data_path``                  | ``FSCRAWLER_FS_OCR_DATA_PATH``                  | ``null``         | `OCR Data Path`_                  |
+---------------------------------------+-------------------------------------------------+------------------+-----------------------------------+
| ``fs.ocr.output_type``                | ``FSCRAWLER_FS_OCR_OUTPUT_TYPE``                | ``txt``          | `OCR Output Type`_                |
+---------------------------------------+-------------------------------------------------+------------------+-----------------------------------+
| ``fs.ocr.pdf_strategy``               | ``FSCRAWLER_FS_OCR_PDF_STRATEGY``               | ``auto``         | `OCR PDF Strategy`_               |
+---------------------------------------+-------------------------------------------------+------------------+-----------------------------------+
| ``fs.ocr.page_seg_mode``              | ``FSCRAWLER_FS_OCR_PAGE_SEG_MODE``              | ``01``           | `OCR Page Seg Mode`_              |
+---------------------------------------+-------------------------------------------------+------------------+-----------------------------------+
| ``fs.ocr.preserve_interword_spacing`` | ``FSCRAWLER_FS_OCR_PRESERVE_INTERWORD_SPACING`` | ``false``        | `OCR Preserve Interword Spacing`_ |
+---------------------------------------+-------------------------------------------------+------------------+-----------------------------------+
...
.. note:: When omitted, ``auto`` value is used. OCR is skipped on PDF pages that already contain more than
