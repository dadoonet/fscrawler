...
public class ByteSizeValueTest extends AbstractFSCrawlerTestCase {
    ...
    public void testByteSizeConversion() {
        ...
        for (int i = 0; i < 500; i++) {
            ...
            switch (unitNumber) {
                case 1: unit = ByteSizeUnit.KB; break;
                case 2: unit = ByteSizeUnit.MB; break;
                case 3: unit = ByteSizeUnit.GB; break;
                case 4: unit = ByteSizeUnit.TB; break;
                case 5: unit = ByteSizeUnit.PB; break;
            }
