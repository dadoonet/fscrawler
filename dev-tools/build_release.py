...
"""
 ...
 steps necessary for a release from a high level point of view it does the following things:
  ...
  - creates a release branch & updates pom.xml and README.markdown to point to a release version rather than a snapshot
...
README_FILE = ROOT_DIR + 'README.markdown'
...
# Add in README.markdown file the next snapshot
...
# Set release date in README.markdown file
...
# Update installation instructions in README.markdown file
