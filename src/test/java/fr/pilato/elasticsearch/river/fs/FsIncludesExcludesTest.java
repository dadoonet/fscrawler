...
public class FsIncludesExcludesTest {
	...
	public void extract_from_array_and_remove_duplicates() throws Exception {
		...
		XContentBuilder xb = jsonBuilder()
				...
				.endObject()
				.endObject();
		String[] includes = getIncludesFromXContent(xb);
	...
	private String[] getIncludesFromXContent(XContentBuilder xb) throws IOException {
		...
		return FsRiverUtil.buildArrayFromSettings(map, "fs.includes");
	}
}
